  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved picture as @picture" do
        ...
        post :create, {:picture => { "filepicker_url" => "invalid value" }}, valid_session
        assigns(:picture).should be_a_new(Picture)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested picture" do
        ...
        Picture.any_instance.should_receive(:update_attributes).with({ "filepicker_url" => "MyString" })
        put :update, {:id => picture.to_param, :picture => { "filepicker_url" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the picture as @picture" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Picture.any_instance.stub(:save).and_return(false)
        put :update, {:id => picture.to_param, :picture => { "filepicker_url" => "invalid value" }}, valid_session
        assigns(:picture).should eq(picture)
      end
